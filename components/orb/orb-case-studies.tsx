    ...
    <section className="relative mx-auto lg:px-8 px-4 2xl:px-20 py-10 mt-10 hidden lg:block">
      ...
      <div className="hidden md:block">
        ...
        <div className="grid grid-cols-2 gap-8 mb-8 h-[425px]">
          {/* First Card */}
          <div className="p-8 rounded-2xl bg-[#D5C4D0]">
          ...
          <div className="p-8 rounded-2xl bg-[#CFD2D4]">
            <div className="flex flex-col h-full">
              ...
              <div className="w-full h-[1px] bg-[#767676] opacity-20 mb-8"></div>
              <div className="flex justify-between mt-auto">
                {features[1].metrics.map((metric, idx) => (
                  <div key={idx} className="flex flex-col">
                    <span className="text-[40px] font-semibold tracking-tight text-[#767676]">
                      {metric.value}
                    </span>
                    <span className="text-[#767676] font-semibold tracking-tight text-xl">
                      {metric.label}
                    </span>
                  </div>
                ))}
        ...
        <div className="grid grid-cols-3 gap-8 ">
          {/* First Card */}
          <div className="p-8 rounded-2xl bg-[#86B9D3] h-[403px]">
            <div className="flex flex-col h-full">
          ...
          {/* Second Card */}
          <div className="p-8 rounded-2xl bg-[#DDE7EA] h-[403px]">
            <div className="flex flex-col h-full">
              <div className="flex justify-between my-auto">
          ...
          {/* Third Card */}
          <div className="p-8 rounded-2xl bg-[#CBC5DD] h-[403px]">
            <div className="flex flex-col h-full">
              <p className="text-[#434343] text-lg font-semibold tracking-tight my-auto">
