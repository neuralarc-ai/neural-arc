      ...
      <div className="flex flex-col lg:flex-row items-center justify-center 2xl:gap-24 gap-8 lg:h-[330px] py-8">
        ...
        <div className="flex flex-col justify-between flex-shrink-0 h-full">
          ...
          <button 
            ...
            className="hidden flex-shrink-0 lg:inline-flex justify-center items-center text-base lg:text-xl gap-4 mt-10 px-8 py-4 bg-[#2F2C28] text-white rounded-full transition-all hover:bg-[#2F2C28] shadow-[0_5px_0_0_#C6AEA3] hover:shadow-[0_3px_0_0_#C6AEA3] duration-300 ease-in-out"
          >
