...
const AboutHero = () => {
  return (
    <section className="mx-auto w-full">
      <div className="h-[618px] lg:h-auto flex rounded-4xl mb-10 flex-col gap-6 py-54 text-center mx-auto bg-[url('/images/about/about-hero-mobile.png')] lg:bg-[url('/images/about/about-hero.png')] bg-cover bg-center bg-no-repeat">
        
        <h1 className="text-[#868686] font-semibold lg:text-5xl text-lg">
          NeuralArc
        </h1>
        ...
        NeuralArc is breaking down the barriers to AI adoption. With our NOD  platform and MicroSaaS suite, we deliver powerful, industry-specific insights to businesses that don&apos;t have data teams—so you can make smarter decisions, faster.
        </p>
      </div>
      <div className="h-[520px] mb-10 rounded-3xl bg-[url('/images/about/smarter-business-mobile.png')] xl:bg-[url('/images/about/smarter-business.png')] bg-cover bg-no-repeat flex lg:items-center lg:px-25 px-8 py-10 xl:py-0">
        <div className="max-w-[693px] xl:mx-0 mx-auto flex flex-col items-center lg:justify-center gap-6 tracking-tighter text-center xl:text-start">
