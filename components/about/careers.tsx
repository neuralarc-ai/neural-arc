  ...
  return (
    <section className="w-full mx-auto py-16">
      ...
      <div className="text-center mb-16">
        <h1 className="text-3xl lg:text-7xl font-semibold text-[#373737] mb-6 tracking-tight">
          Careers at NeuralARC
        </h1>
        <p className="text-xl lg:text-2xl font-semibold text-[#55493D] mx-auto lg:px-20 tracking-tight">
