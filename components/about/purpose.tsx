  ...
  return (
    <section className="xl:h-[1418px] rounded-4xl flex items-center justify-center py-25 bg-[url('/images/about/purpose-mobile.png')] lg:bg-[url('/images/about/purpose.png')] bg-cover bg-no-repeat">
        <div className="flex text-white flex-col gap-6 xl:p-22 self-center w-fit rounded-2xl bg-[url('/images/about/inner.png')] bg-no-repeat bg-cover">
            ...
            At Neural Paths, we believe that intelligence—both artificial and human—should be a force multiplier, not a barrier. We are here to break down the walls between innovation and access, building tools that don&apos;t just analyze data, but empower the people behind it.
            <br /><br />
            ...
            <br /><br />
            Our philosophy blends the precision of technology with the unpredictability of human ambition. We are not chasing hype we are shaping habits. In a world racing toward automation, Neural Paths is focused on augmentation elevating everyday decisions with intelligence that feels intuitive.
