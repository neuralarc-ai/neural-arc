      ...
      <div className="bg-[url('/images/case-study/dashboard-bg.png')] overflow-hidden bg-cover bg-center rounded-3xl flex flex-col xl:flex-row gap-8 2xl:h-[800px] xl:h-[750px]">
        ...
        <div className="w-full xl:w-[549px] h-fit flex-shrink-0 flex flex-col items-center justify-center xl:items-center xl:justify-center p-4 md:p-8 my-auto">
          ...
          <div className="xl:hidden w-full flex justify-center mb-8">
            <div className="relative w-full h-[220px] lg:h-[440px]">
        ...
        <div className="hidden xl:block w-full items-center justify-center relative pt-8 pr-8">
          ...
          <div className="absolute bottom-0 right-0 xl:-right-20 xl:-bottom-25 2xl:right-10 2xl:-bottom-20 w-full h-full">
            <Image src={image} alt={imageAlt} width={1000} height={1000} className="object-contain xl:scale-125 2xl:scale-100" priority />
          </div>
        </div>
      </div>
    </section>
