  ...
  return (
    <section className="w-full max-w-[1858px] mx-auto px-4 md:px-8 py-12">
      <div className="relative bg-[#DEDED1] rounded-[24px] px-6 lg:px-12 py-12 lg:py-20 flex flex-col justify-between overflow-hidden 2xl:h-[1054px]">
        ...
        {mobileImage && (
          <div className="lg:hidden hidden md:block absolute top-0 left-0 w-full h-[390px] z-0 mt-16 scale-80">
            <Image src={mobileImage} alt={imageAlt} fill className="object-cover" priority />
          </div>
        )}
        {/* Title and Image */}
        <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between relative z-10 md:mb-32 lg:mb-0">
          ...
          <div className="hidden lg:block absolute -top-46 -right-28 z-0 lg:w-[340px] lg:h-[380px] xl:w-[840px] xl:h-[640px]">
