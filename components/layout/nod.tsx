  ...
  return (
    <section className="relative mx-auto lg:px-8 px-4 2xl:px-20 py-10 mt-10">
      <div className="flex flex-col items-center text-center">
        ...
        {/* NOD Title */}
        <h2 className="text-[#76716E] text-3xl font-semibold mb-2">
          NOD
        </h2>

        {/* Acronym */}
        <h1 className="text-[#373737] text-2xl lg:text-5xl font-normal mb-2">
          <span className="font-bold">N</span>avigate. <span className="font-bold">O</span>ptimize. <span className="font-bold">D</span>isrupt.
        </h1>
        ...
        <p className="text-[#181A1A] text-base lg:text-2xl px-4 font-light mb-12">
          Unlock the potential of neural intelligence tailored for your business. NOD analyzes over 14 billion parameters in real-time, revealing insights beyond traditional analytics. Our unique architecture adapts to your industry&apos;s patterns, learning from 375,000 decision NODes to uncover correlations that human analysts might overlook. With the ability to process 8.7 million data points per second, we turn complexity into clarity, empowering you to anticipate tomorrow&apos;s opportunities.
        </p>
